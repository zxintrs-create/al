...
local function detectRelationshipCategory(input)
  ...
  local checks = {
    ...
    {"cemburu", {"aku cemburu", "kamu bikin aku cemburu", "aku jadi cemburu", "aku cemburu sama dia", "cemburu sama dia", "aku iri sama dia", "kenapa dekat sama dia", "kenapa deket sama dia", "kok dekat sama dia", "kok deket sama dia", "kenapa sama dia"}},
...
local function getVioletResponse(input)
  ...
  local fallback = {
    "Aku dengar. Lanjutkan sedikit supaya aku nggak salah paham. 💜",
    "Aku belum menangkap maksudmu sepenuhnya. Ceritakan sedikit lagi.",
    "Hm? Aku masih mengikuti percakapan kita.",
    "Lanjutkan. Aku ingin memahami maksudmu, bukan asal menjawab."
  }

  conversationContext.category = "general"
  conversationContext.stage = 1
  return chooseContextual(fallback, lower, "general")
end
