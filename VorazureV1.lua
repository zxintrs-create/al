...
makeLabel(sec1,"Klik objek untuk select, lalu gunakan tool di bawah",Color3.fromRGB(150,150,180),9)
...
local backdoorKeywords={"backdoor","admin","owner","auth","password","secret","hidden","kick","ban","teleport","loadstring","loadfile","dofile","http","webhook","execute","exploit","bypass","rank","mod","god","fly","noclip","invisible","cmds","commands","console","adminpanel","adpan","give","tool","gear","spawn","delete","remove","control","manage","remote","event","fire","invoke","server","client","replicate","antikick","antiban","scripts","load","run","test","debug","log","token","key","api","callback","hook","hack","cheat","sudo","cmd","command","panel","paneladmin","adminpanel","admingui","admincmd","cmdpanel","staff","moderator","setrank","changerank","promote","demote","permission","perms","access","level","role","group","team","setteam","jointeam","spectate","follow","goto","bring","tpto","tween","move","slide","freeze","unfreeze","destroy","kill","slay","reset","respawn","revive","heal","godmode","jump","speed","walkspeed","jumppower","gravity","size","scale","remotes","events","bind","function","call","trigger","activate","compile","script","source","code","bytecode","decompile","dump","read","write","file","folder","directory","path","create","upload","download","save","config","settings","options","preferences","configfile","json","data","savefile","loadfile","readfile","writefile","appendfile","httpget","https","request","post","get","fetch","discord","url","link","ip","address","port","connect","socket","network","send","receive","message","chat","broadcast","notice","notification","alert","warn","error","output","terminal","shell","system","os","process","thread","coroutine","delay","time","clock","timer","counter","loop","while","repeat","for","if","then","else","end","function","return","local","global","var","value","set","get","insert","find","match","gsub","sub","char","byte","len","rep","reverse","upper","lower","tonumber","tostring","type","typeof","rawget","rawset","rawlen","select","unpack","pack","pairs","ipairs","next","table","string","math","vector","cframe","udim","udim2","color","ray","region","path","waypoint","point","node","graph","tree","stack","queue","list","map","index","hash","id","uid","guid","name","title","desc","description","tag","label","icon","image","sound","part","mesh","union","solid","model","folder","collection","service","instance","class","object","proto","module","package","lib","library","sdk"}
...
b.Text="📍 "..p.Name.." ("..(p.Character and p.Character:FindFirstChild("HumanoidRootPart")and "Distance: "..math.floor((p.Character.HumanoidRootPart.Position-player.Character and player.Character:FindFirstChild("HumanoidRootPart")and player.Character.HumanoidRootPart.Position or Vector3.new()).Magnitude).."" or "No Char")..")"
b.TextColor3=Color3.fromRGB(200,190,230)
...
makeLabel(sec4,"Coodinat Teleport",Color3.fromRGB(150,150,200),10)
...
local refreshBtn=makeButton(sec4,"🔄 Refresh Player List",Color3.fromRGB(60,100,160),refreshPlayerList)

local tab5=createTab("SKY","🌈")
local sec5=makeSection(tab5,"Skybox Changer & Map Save/Load")

local skyInput=makeInput(sec5,"Skybox ID (rbxassetid://...)","APPLY",Color3.fromRGB(60,120,200),function(id)
protect(function()
local skyId=id
...
local skySaveBtn=makeButton(sec5,"💾 Save Skybox ID",Color3.fromRGB(60,140,80),function()
protect(function()
...
local skyLoadBtn=makeButton(sec5,"📂 Load Skybox ID",Color3.fromRGB(60,80,140),function()
protect(function()
...
local mapSaveBtn=makeButton(sec5,"💾 Save Map (Workspace)",Color3.fromRGB(60,160,90),function()
protect(function()
local data={}
local count=0
...
local mapLoadBtn=makeButton(sec5,"📂 Load Map (from Save)",Color3.fromRGB(60,90,160),function()
protect(function()
local c=readfile("AldoVzMap.json")
if not c or #c==0 then
notify("📂 Load","File map tidak ditemukan!",1.5)
return
end
...
protect(function()h:Destroy()end)
end
