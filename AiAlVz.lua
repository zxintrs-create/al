...
_G.DeltaMobileControlsCleanup = function() if destroyed then return end; destroyed = true; disconnectAll(); destroyGui("DeltaMobileErgo"); destroyGui("FullEdgeTouchFix") end
destroyGui("DeltaMobileControls")
destroyGui("DeltaMobileErgo")
destroyGui("FullEdgeTouchFix")
...
local MUSIC_LIST = {
    ...
    {"PREMIUM", "90822723856447"},
    {"JUNGLEDUTCH4", "124215070610500"},
    {"JUNGLEDUTCH3", "79487433912200"},
    {"UNTOLD2", "132607899221428"},
    {"JUNGLEDUTCH", "112263562729454"},
    {"JUNGLEDUTCH2", "97792829444935"},
    {"PREMIUM3", "132582600949537"},
    {"PREMIUM7", "103800667145646"},
    {"PREMIUM10", "118939174937482"},
    {"PREMIUM4", "122573703160116"},
    {"PREMIUM2", "89595963956527"},
    {"PREMIUM5", "96565075941797"},
    {"PREMIUM6", "108961166641784"},
    {"PREMIUM8", "97133941289019"},
    {"RNBXREGGAE", "133649635243899"},
    {"PREMIUM9", "70557591697216"},
    {"ALWAYS LOVING YOU", "136348284776333"},
    {"KULOSA AFRO", "101625144848507"},
    {"YBxBRAVY", "134767900842088"},
    {"THE LOTUS", "122214021474859"},
    {"RNB", "111400349314179"},
    {"ENHYPEN", "71783464640666"},
    {"MOSKI MIXING-EDIT", "94915974301909"},
    {"PELLI GROSA", "124203312170587"},
    {"SUMMERTIME SADNESS-BKB", "122484660035595"},
    {"GOBLAYDJ3", "106347024097280"},
    {"GOBLAYDJ", "127428477577688"},
    {"DJTORANG2", "138533730431928"},
    {"DJBRONDONGTUA", "71175666271402"},
    {"GOBLAYDJ2", "131887212962755"},
    {"GOBLAYDJ4", "134292102085674"},
    {"KAMNH-TURKIYE DJ", "121806662658586"},
    {"MANGU-BKB", "131652989987734"},
    {"LAKSAMANA-EDIT", "95344850304376"},
    {"AKU DAH LUPA-AMAPIANO/AFRO", "125513366895439"},
    {"JANGANTUNGGULAMADJ", "80364871526161"},
    {"DJ JANGANLAGIXUNTOLD", "134678302591468"},
    {"LAKSAMANALAUT", "138848940838199"},
    {"TABOLEBALE-AFRO", "107265360766651"},
    {"DJTIKUSKANTOR", "83302808222802"},
    {"OPHELIA-EDIT", "103786436819036"},
    {"MULTO-REMIX", "86320346259188"},
    {"MEJIKUHI-AFRO/AMAPIANO", "72995403782923"},
    {"MASIHMENCINTAINYA-BKB", "105786350102733"},
    {"NDXBARUDAK", "95762941984038"},
    {"NDXM", "122110544887517"},
    {"NDXT", "135245530901769"},
    {"NDXRA", "77827329846079"},
    {"NDXR", "128269243739623"},
    {"NDXAPA", "79752675769309"},
    {"NDXJ", "108424916232756"},
    {"NDXAKA", "124342415383675"},
    {"NDXA", "98660530240325"},
    {"NDX", "77033739875463"},
    {"NDXNG", "102707338779059"},
    {"NDXS", "14043340891638"},
    {"HIPDUT", "90054703282961"},
    {"ADABAYANGMU", "92019113516173"},
    {"FUNKOTB", "100665776847807"},
    {"FUNKOTBG", "97686567218790"},
    {"FUNKOTBR", "115280652867915"},
    {"FUNKOTMJ", "122992720529867"},
    {"FUNKOTP", "113274644643430"},
    {"FUNKOT", "78778222633072"},
    {"BEATANDBEAUTY-BKB", "84978726175650"},
    {"STICKY-EDIT", "137974441536421"},
    {"LOST-BKB", "114150015912954"},
    {"COMCLOSER-AFRO", "82224883521975"},
    {"SI-AI", "106560549670623"},
    {"NOKIAxHARDTECHNO", "134875557576460"},
    {"DOMINATION-HARDSTYLE", "140429522861678"},
    {"WHT DID I-EDIT", "93057487353101"},
    {"GOBLAYDRIP", "138122828693882"},
    {"VOICEMYHEAD", "84508877531864"},
    {"OPHELIA-BKB", "72404463504410"},
    {"MARTINGARRIX-OPENING", "72464183443122"},
    {"BBHCDROP", "97894779508233"},
    {"DAVIDGUETTA-OPENING", "103603344537026"},
    {"PENDIENTE A MI-AFRO", "79968047744034"},
    {"DROPV1", "97668163649808"},
    {"MACARENA-AFRO", "98498424772533"},
    {"YANK-HARDTECHNO", "74779862658417"},
    {"CASSABLANCA-AFROARABIC", "95823754312648"},
    {"WHT DID I2", "117463881213118"},
    {"A THOUSAND MILES-REMIX", "121155012325325"},
    {"SOLANA-ARABIC VIBE", "120648580377310"},
    {"CONTIGORIDDIM-AFRO", "121291816432954"},
    {"UNTOLD-DRIP", "128153652270763"},
    {"JUMP-BLACKPINK HARDTECHNO", "137605887582004"},
    {"TOMORROWLAND", "96426557764288"},
    {"UNTOLD", "99695104795091"},
    {"NANANA-TOMORROWLAND", "109116501377332"},
    {"TOMORROWLAND2", "93920274108159"},
    {"TOMORROWLAND3", "79529350578524"},
    {"TOMORROWLAND4", "122243519634652"},
    {"HOTEL-BKB", "71086964766920"},
    {"KENDRICLAMAR-EDIT", "13166961603371"},
    {"UNTOLDxFEIN", "130838880340042"},
    {"DROPBBHC", "96077716999619"},
    {"ARIAXWHT DID I", "134618729524894"},
    {"DROPV2", "112721530496321"},
    {"LAYLA-ARABIC", "84957008366995"},
    {"STARS-BKB", "72982118103539"},
    {"UNTOLD DROP", "95309079186262"},
    {"BLOODLINEBBHC", "127688795465474"},
    {"CALMA-EDIT", "79813480970752"},
    {"THEYDONTCAREBOUTUS", "77444210362656"},
    {"KICAWMANIAXGBP", "117490943216395"},
    {"VoiceMYHeadvsUntold", "135949714043130"},
    {"HoldOnvsGoyangDumang", "96802575255259"},
    {"FREAKstadiumXunTold", "96768544061588"},
    {"PUMPITxNathalieScholer", "108875098890429"},
    {"FADEDxAlone-BKB", "71796446041985"},
    {"SweetLove-BKB", "75757010110222"},
    {"UNTOLDx", "77536780575883"},
    {"Meletus Balon-BKB", "116246541137120"},
    {"DRIVE-BKB", "109439648206519"},
    {"BKB", "129533180290802"},
    {"MI-CASA", "89876556747926"},
    {"WE LIKE PARTY", "127013387960081"},
    {"UNTOLDxEdit", "132828897153563"},
    {"CRAZYFROG-EDIT", "81936690194707"},
    {"BRONDONGTUA-EDIT", "93929731286479"},
    {"METAL-MOSHING", "80135939236410"},
    {"Chinese-Techno", "124173325049449"},
    {"NU-BKB", "110142421655872"},
    {"BANGBANG-TECHNO", "127362780897851"},
    {"LZN", "136771838352252"},
    {"Dora-BKB", "80603469155924"},
    {"Alone-BKB", "76500146769556"},
    {"DJ-ORANGE", "83647126861606"},
    {"MAKI (MEMORIES)-BKB", "121320117547577"},
    {"Baby Dont GO-YB", "89258214343243"},
    {"DJ-Tuhan Tolong Aku", "120202508460082"},
    {"Chinese-DJ", "88077167290999"},
    {"DJ-Untold", "112475074751973"},
